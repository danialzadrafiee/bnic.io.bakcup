        ...
        <content action="" class="bg-white h-max card p-8 max-w-full w-full @container/map">
            <grid class="grid grid-cols-8 gap-8 items-start">
                <grid class="js-main-col col-span-6 grid grid-cols-1  w-full gap-2">
                    ...
                    <textarea id="editor" name="description" class="js-event-description block border rounded-lg min-h-[200px]  border-neutral-300 p-2"></textarea>
                    {{-- mapbox --}}
                    <row>
                    ...
                    <footer class="flex justify-between">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <label for="end_at" class="block px-3 text-xs w-max py-2 rounded-t-none border border-t-0 rounded-lg border-neutral-5/30 font-medium text-gray-700">Ending date</label>
                        </div>
                        <button class="js-create-invite ml-auto flex btn btn-primary">Create invitation</button>
                    </footer>
                </grid>
                <users class="col-span-2 mt-2 js-invite-list-section grid grid-cols-1 gap-2 grow h-max">
