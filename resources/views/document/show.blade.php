...
<x-layout.dashboard :user="$corp">
    ...
    <input type="hidden" class="js-is-owner" value="{{ auth()->user()->id == $document->corporation_id ? 'true' : 'false' }}">
    <main class="flex">
        <core class="w-full">
                        ...
                        @if (auth()->user()->id != $document->corporation->id)
                            ...
                            <additional class="px-20 w-full block">
                                ...
                                <row class="js-row-additional grid grid-flow-col gap-2 py-2 justify-stretch w-full ">
                                    <input name="ad_email[]" placeholder="Email" readonly class="js-input-email input border-neutral-5/30">
                                    <input name="ad_role[]" placeholder="Role" class="input border-neutral-5/30">
                                    <input name="ad_describe[]" placeholder="Describe" class="input border-neutral-5/30">
                                    <button type="button" class="js-add-additional-row btn btn-neutral"> + </button>
                                    <button type="button" class="js-rem-additional-row btn btn-error" style="display: none"> -
                                    </button>
                                </row>
                            </additional>
                        @endif
