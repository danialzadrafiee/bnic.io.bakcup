...
function addRow(columns) {
    ...
    deleteButton.classList.add("css_delete", "absolute", "-top-4", "-right-4", "bg-base-content", "hover:bg-red-400", "transition-all", "text-white", "w-8", "h-8", "px-2", "rounded-full")
...
var eventsList = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "keydown", "keyup", "keypress", "change", "focus", "blur", "load", "unload", "beforeunload", "resize", "move", "DOMContentLoaded", "readystatechange", "error", "abort", "scroll"]
